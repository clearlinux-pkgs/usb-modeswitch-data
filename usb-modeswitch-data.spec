...
Version  : 20191128
Release  : 4
URL      : http://www.draisberghof.de/usb_modeswitch/usb-modeswitch-data-20191128.tar.bz2
Source0  : http://www.draisberghof.de/usb_modeswitch/usb-modeswitch-data-20191128.tar.bz2
...
%description data
data components for the usb-modeswitch-data package.


%package license
Summary: license components for the usb-modeswitch-data package.
Group: Default

%description license
license components for the usb-modeswitch-data package.


%prep
%setup -q -n usb-modeswitch-data-20191128
cd %{_builddir}/usb-modeswitch-data-20191128
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609781974
...
cp %{_builddir}/usb-modeswitch-data-20191128/COPYING %{buildroot}/usr/share/package-licenses/usb-modeswitch-data/dfac199a7539a404407098a2541b9482279f690d
%make_install RULESDIR=%{buildroot}/usr/lib/udev/rules.d
...
/usr/share/usb_modeswitch/03f0:9d1d
/usr/share/usb_modeswitch/03f0:a31d
...
/usr/share/usb_modeswitch/0586:2030
...
/usr/share/usb_modeswitch/0846:0fff
...
/usr/share/usb_modeswitch/2001:00a7
...
/usr/share/usb_modeswitch/22de:6802
